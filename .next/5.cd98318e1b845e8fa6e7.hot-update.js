...
var _default = function _default(theme) {
  var _outerContainer, _innerContainer;
  ...
  return {
    ...
    innerContainer: (_innerContainer = {
      ...
      paddingRight: theme.spacing.unit * 4,
      flex: '1 1 100%'
    }, _defineProperty(_innerContainer, theme.breakpoints.between('sm', 'xl'), {
      paddingLeft: theme.spacing.unit * 6,
      paddingRight: theme.spacing.unit * 6
    }), _defineProperty(_innerContainer, theme.breakpoints.between('md', 'xl'), {
      '. *': {
        maxWidth: theme.spacing.unit * 30
      }
    }), _innerContainer),
...
//# sourceMappingURL=5.cd98318e1b845e8fa6e7.hot-update.js.map